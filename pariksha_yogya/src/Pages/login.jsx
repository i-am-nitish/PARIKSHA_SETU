    ...
    <div className="flex h-[calc(100vh-14px)] bg-gray-50 dark:bg-gray-900 overflow-hidden pt-[74px]">
      ...
      <div className="flex flex-col w-full md:w-1/2 justify-center items-center px-6 py-4">
        <div className="w-full max-w-md">
          <h1 className="text-xl font-bold text-gray-800 dark:text-white mb-1 text-center">Join Pariksha Yogya</h1>
          <p className="text-center text-gray-600 dark:text-gray-400 text-sm mb-2">Your success journey begins here</p>
          ...
          <p className="text-center mt-3 text-sm text-gray-700 dark:text-gray-300">
            ...
            <Link to="/signup" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
              Create account
            </Link>
          </p>
        </div>
