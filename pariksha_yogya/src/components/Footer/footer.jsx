...
const Footer = () => {
  return (
    <div className="relative bg-[rgba(231,231,231,0.4)] dark:bg-gray-900/80 border border-[rgba(0,0,0,0.4)] dark:border-gray-700 py-3 overflow-hidden rounded-lg">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-start justify-between px-6 max-w-7xl mx-auto">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left mt-6 lg:mt-0 lg:pl-8">
          {/* Boxed section title */}
          <div className="inline-block bg-black dark:bg-gray-800 rounded-lg px-2 py-0.5 mb-4">
          ...
          <div className="flex flex-col items-center lg:items-start space-y-4">
            <div className="flex flex-col items-center lg:items-start max-w-md">
              <div className="mb-2">
                <img src="./logos/py_name.svg" alt="Eligibility Calculator" className="p-2 w-50 h-10 border rounded-lg shadow-md bg-white dark:bg-gray-800 border-[#a8a8a8] dark:border-gray-700" />
              </div>
              <p className="text-black-700 dark:text-gray-300 text-sm text-justify">
            ...
            <div className="flex flex-col items-center lg:items-start max-w-md">
              <div className="mb-2">
                <img src="./logos/pm_name.svg" alt="Expert Roadmaps" className="p-2 w-50 h-10 border rounded-lg shadow-md bg-white dark:bg-gray-800 border-[#a8a8a8] dark:border-gray-700" />
              </div>
              <p className="text-black-700 dark:text-gray-300 text-sm text-justify">
            ...
            <div className="flex flex-col items-center lg:items-start max-w-md">
              <div className="mb-2">
                <img src="./logos/pg_name.svg" alt="AI Chatbot" className="p-2 w-50 h-10 border rounded-lg shadow-md bg-white dark:bg-gray-800 border-[#a8a8a8] dark:border-gray-700" />
              </div>
              <p className="text-black-700 dark:text-gray-300 text-sm text-justify">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left mt-6 lg:mt-0 lg:pl-8">
          ...
          <div className="p-2 border rounded-lg shadow-md flex items-center space-x-4 mb-3 bg-white dark:bg-gray-800 border-[#a8a8a8] dark:border-gray-700">
            <img src="./logos/ps_name.svg" alt="Pariksha Yogya" className="w-45 h-5" />
          </div>

          {/* Description with reduced spacing */}
          <div className="max-w-md text-black-700 dark:text-gray-300 mb-4">
          ...
          <div className="flex items-center mb-4">
            <span className="text-gray-700 dark:text-gray-300 text-sm mr-2">For help and support:</span>
            <a href="mailto:askparikshasetu@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline text-sm">
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-x-6 gap-y-1 mb-4 text-black-700 dark:text-gray-300 text-sm">
      ...
      <div className="relative z-10 border-t border-gray-300 dark:border-gray-700 mt-1 pt-3">
        <div className="flex flex-col sm:flex-row justify-between items-center px-6 max-w-7xl mx-auto text-gray-600 dark:text-gray-400 text-sm">
          <div>Made with ❤️ for Aspirants</div>
          <div className="mt-1 sm:mt-0">
            © {new Date().getFullYear()} | 
            <Link to="/privacy-policy" className="underline hover:text-gray-800 dark:hover:text-gray-200 ml-1">Privacy Policy</Link> | 
            <Link to="/terms-and-conditions" className="underline hover:text-gray-800 dark:hover:text-gray-200">Terms & Conditions</Link> |
            <Link to="/refund-policy" className="underline hover:text-gray-800 dark:hover:text-gray-200">Refund Policy</Link>
          </div>
        </div>
      </div>
    </div>
