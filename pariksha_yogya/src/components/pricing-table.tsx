  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[350px_1fr] gap-4 gap-x-6 mb-8">
  <div className="flex flex-col gap-4">
    {plans.map((plan) => (
      <button
        ...
        className={cn(
          "p-4 rounded-xl text-left transition-all w-full sm:w-auto",
      ...
      >
          ...
          <div className="border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden">
            <div className="overflow-x-auto">
              <div className="min-w-[240px] divide-y divide-zinc-200 dark:divide-zinc-800">
