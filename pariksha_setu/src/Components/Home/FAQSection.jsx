...
const FAQSection = () => {
  ...
  const faqs =
    language === "en"
      ? [
          {
            question: "What is Pariksha Setu?",
            answer:
              "Pariksha Setu is a comprehensive platform designed to help students prepare for competitive exams. It provides personalized learning paths, practice tests, and interactive study materials tailored to various competitive exams.",
          },
          {
            question: "How does Pariksha Setu help in exam preparation?",
            answer:
              "Pariksha Setu offers a three-pronged approach to exam preparation: Pariksha Yogya (personalized learning), Pariksha Marg (strategic preparation paths), and Pariksha ChatBot (intelligent assistant). These tools work together to provide comprehensive support throughout your exam journey.",
          },
          {
            question: "Is Pariksha Setu available for all competitive exams?",
            answer:
              "Currently, Pariksha Setu supports preparation for major competitive exams in India, including UPSC, SSC, Banking, Railways, and various state-level examinations. We are continuously expanding our coverage to include more exams.",
          },
          {
            question: "How personalized is the learning experience?",
            answer:
              "Pariksha Setu uses advanced algorithms to analyze your strengths, weaknesses, and learning patterns. Based on this analysis, it creates a completely personalized study plan and recommends specific resources that align with your learning style and goals.",
          },
          {
            question: "Can I access Pariksha Setu on mobile devices?",
            answer:
              "Yes, Pariksha Setu is fully responsive and can be accessed on smartphones, tablets, laptops, and desktop computers. We also offer a dedicated mobile app for Android and iOS devices for a seamless learning experience on the go.",
          },
          {
            question:
              "What makes Pariksha Setu different from other exam preparation platforms?",
            answer:
              "Pariksha Setu stands out with its integrated approach combining AI-driven personalization, comprehensive content coverage, and community-based learning. Our platform adapts to your individual learning needs while providing quality content vetted by subject matter experts.",
          },
        ]
      : [
          {
